...
void loop() {
  ...
  // delay(1000);
    ...
    unsigned long lineScanTimer = 0; // Variable to keep track of time
    ...
    if (currentMillis > timer)
    {
      if (lineValues[0] >= MAX_BLACK && !lineScanInProgress && lineValues[7] >= MAX_BLACK && !lineScanInProgress) {
        lineScanTimer = currentMillis + 50;// Start the timer
    ...
    // Check if line scanning has been in progress for more than 5 milliseconds
...
//  if (lineValues[0] >= MAX_BLACK && !lineScanInProgress && lineValues[7] >= MAX_BLACK && !lineScanInProgress) {
//         lineScanTimer = currentMillis + 5; // Start the timer
//         lineScanInProgress = true; // Set flag to indicate line scanning is in progress
//         // Serial.println("BBBBBBBBBBBBBBb");
//     }

//     if (lineScanInProgress && (currentMillis < lineScanTimer)) 
//       {
//         if (endRace == false)
//          {
//             scanBlackBox();
